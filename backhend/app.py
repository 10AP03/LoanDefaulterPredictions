...
#  Both template_folder and static_folder point to ../frontend
app = Flask(
    __name__,
...
def predict():
    ...
    model_input = [data[feature] for feature in frozen_feature_list]
    ...
    # Changed "default probability" (space) to "default_probability" (underscore)
    return jsonify({
        "status": "success",
